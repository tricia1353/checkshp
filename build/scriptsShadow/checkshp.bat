...
set CLASSPATH=%APP_HOME%\lib\checkshp-0.1.0.jar

@rem Execute checkshp
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CHECKSHP_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%CHECKSHP_EXIT_CONSOLE%" exit 1
exit /b 1
